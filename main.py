...
Criterion = 'Melt' #Criterion to use for ablation; either 'ncrit', 'ncritmod', or 'Melt'
ThresholdPercentage = 7 #Percent ionization used for ultrafast melting
...
Plot_nCB_vs_time = False
Plot_nCB_final_vs_intensity = False
Plot_photoionization_vs_time = False
...
SavePlots = True #Save selected plots
...
theta = 31.0 #AOI in degrees
Polarization = 'p' #Polarization

Wavelength_Stepsize = 0.02
MinWavelength = 2.7 #Min wavelength to calculate
MaxWavelength = 4.5 #Max wavelength to calculate
Wavelength = np.arange(MinWavelength,MaxWavelength+Wavelength_Stepsize,Wavelength_Stepsize)
...
MinIntensity = 2 #Miniumum peak laser intensity in TW/cm^2
MaxIntensity = 3 #Maximum peak laser intensity in TW/cm^2
DesiredStepSize = 0.05
#DesiredStepSize = 0.1
NumIntensities = int(np.round((MaxIntensity-MinIntensity)/DesiredStepSize))
...
PulseDuration[PulseDuration==0] = 200. #Set to 100 fs for all wavelengths
#PulseDuration[Wavelength==0.78] = 70. #70 fs for 0.78 um
#PulseDuration[Wavelength==2.4] = 100. #100 fs for 2.4 um
#PulseDuration[PulseDuration==0] = 90. #90 fs otherwise
...
#==============================================================================
SelectWavelength = 3.15 #Desired wavelength to plot (um)
