...
Plot_threshold_vs_wavelength = False
Plot_Efield_vs_time = False
...
MinIntensity = 30 #Miniumum peak laser intensity in TW/cm^2
MaxIntensity = 520 #Maximum peak laser intensity in TW/cm^2
DesiredStepSize = 0.1
#DesiredStepSize = 0.1
...
PulseDuration[PulseDuration==0] = 7. #Set to 100 fs for all wavelengths
