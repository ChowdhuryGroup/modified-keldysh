...
Direction = '[010]' #Crystal direction along which the polarization is oriented ([110] for s, [111] for p)
theta = 45 #AOI in degrees
Polarization = 'p' #Polarization

Wavelength_Stepsize = 0.01
MinWavelength = .76 #Min wavelength to calculate
MaxWavelength = .76 #Max wavelength to calculate
...
MinIntensity = 60 #Miniumum peak laser intensity in TW/cm^2
MaxIntensity = 530 #Maximum peak laser intensity in TW/cm^2
DesiredStepSize = 0.1
#DesiredStepSize = 0.1
