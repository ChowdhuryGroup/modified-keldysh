...
Wavelength_Stepsize = 0.05
MinWavelength = 3.9 #Min wavelength to calculate
MaxWavelength = 3.95 #Max wavelength to calculate
Wavelength = np.array((3.6,3.95))
...
MaxIntensity = 1 #Maximum peak laser intensity in TW/cm^2
DesiredStepSize = 0.1
#DesiredStepSize = 0.1
NumIntensities = 750 #int(np.round((MaxIntensity-MinIntensity)/DesiredStepSize))
#NumIntensities = 150 #Number of intensities
Intensity = np.logspace(MinIntensity,MaxIntensity,NumIntensities,base=10)
