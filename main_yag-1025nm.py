...
Wavelength = np.array([1,1.025,1.1])
...
MinIntensity = 10 #Miniumum peak laser intensity in TW/cm^2
MaxIntensity = 40 #Maximum peak laser intensity in TW/cm^2
DesiredStepSize = 0.1
#DesiredStepSize = 0.1
...
PulseDuration[PulseDuration==0] = 264. #Set to 100 fs for all wavelengths
